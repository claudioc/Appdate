...
$view->addHelperPath(APPLICATION_PATH . "/views/helpers", 'Appdate_View_Helper');
...
$frontController->getRouter()->addConfig($configuration, 'routes');

$frontController->registerPlugin(new AppdateCookiePlugin());
